...
| Menu/popover/sheet/tooltip | BfActionMenu roles, arrow/Home/End/Escape/Tab behavior, selection, destructive and disabled items | Portal positioning, viewport edge placement, dismissal, focus return | Both themes; edge placement | Existing Radix APIs and nested-menu behavior preserved through adapters |
