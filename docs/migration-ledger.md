...
| Overlays | `ui/dialog.tsx:10`, alert dialog, sheet, menu, popover, tooltip | BfDialog + BfActionMenu plus compatible overlay family | Preserve Radix focus/portal/keyboard contracts | Dialog and local action-menu source ready; broader family adapters planned |
